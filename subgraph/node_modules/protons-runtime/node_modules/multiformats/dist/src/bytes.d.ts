 ...
 */
export declare function coerce(o: ArrayBufferView | ArrayBuffer | Uint8Array): Uint8Array<ArrayBuffer>;
 ...
 */
export declare function fromString(str: string): Uint8Array<ArrayBuffer>;
/**
 ...
 */
export declare function toArrayBufferBackedArray(b: Uint8Array): Uint8Array<ArrayBuffer>;
